    ...
    <Container>
      <div className="py-5">
       ...
       <div className="flex mt-5 gap-5 items-center border-b-1 border-[#26262622]">
        <p className='line-through text-[20px] font-dm pb-5'>$88.00</p>
        <p className=' text-[24px] font-dm font-semibold pb-5'>$44.00</p>
       </div>
       ...
       <div className="flex gap-8 mt-[25px] items-center">
        ...
        <div className="">
          ...
          <FaCircle className='text-[26px] text-[rgba(0,0,0,0.22)]'/>
          <FaCircle className='text-[35px] text-[#FF8686]'/>
          <FaCircle className='text-[26px] text-[#7ED321]'/>
          <FaCircle className='text-[26px] text-[#f03a3a]'/>
          <FaCircle className='text-[26px] text-[#15CBA5]'/>
          </div>
        </div>
       </div>
