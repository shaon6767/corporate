...
const Pagination = ({pageNumber,paginate,next,previous,currentPage,filterShow}) => {

    return (
        <Container>
            <div className="pl-[250px]">
                <nav aria-label="Page navigation example" className={`${filterShow.length > 0 ?"hidden" :"py-2"}`}>
